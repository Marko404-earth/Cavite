...
<head>
  ...
  <style>
    :root { --sidebar-width: 220px; --accent: #4DA8DA; --bg: #11151a; --header-h: 120px; }
    html, body { 
    height: 100%; 
    margin: 0; 
...
<body>
  ...
  <center>
  <blockquote style="color: #4DA8DA">
    <footer><p>@2025 Wonders of Cavite|All Rights Reserved</p></footer>
  </blockquote>
  </center>
</body>
</html>
